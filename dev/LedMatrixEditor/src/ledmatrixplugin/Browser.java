...
class Browser extends Region {
    ...
    public LedMatrixServer serverObject;
    ...
    public Browser(Editor editor) {
        ...
        changeListener = new ChangeListener<State>() {
                ...
                public void changed(ObservableValue<? extends State> ov,
                    ...
                    if (newState == State.SUCCEEDED) {
                        ...
                        serverObject = new LedMatrixServer(editor, Browser.this.getScene().getWindow());
                            JSObject win = (JSObject) webEngine.executeScript("window");
                            win.setMember("LedMatrixServer", serverObject);
                        }else{
                    }
                    }
                };
        ...
        webEngine.setPromptHandler((PromptData param) -> {
            ...
            prompt.setTitle("LedMatrixEditor");
        ...
        baseurl = baseurl.replace("LedMatrixPlugin.jar", "");
        
        webEngine.load(baseurl + "led-matrix-editor/index.html");
