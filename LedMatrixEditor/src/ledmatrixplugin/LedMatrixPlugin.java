 ...
 */
public class LedMatrixPlugin implements Tool {
    ...
    public static void main(String[] args) {
        LedMatrixPlugin.startApplication();               
    ...
    public static void startApplication(){
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                LedMatrixPlugin plugin = new LedMatrixPlugin();
                try {
    ...
    public void run() {
        try{
            LedMatrixPlugin.editor.toFront();
    ...
    public String getMenuTitle() {
        return "LedMatrixEditor";
    }

    @Override
    public void init(Editor editor) {
        LedMatrixPlugin.editor = editor;        
    }
}